...
param aoaiGpt4ModelName string= 'gpt-5.6-sol'
param aoaiGpt4ModelVersion string = '2026-07-09'
param aoaiGpt4ModelDeploymentName string = 'gpt-5.6-sol'
...
// NOTE: sku must be GlobalStandard for gpt-5.6-sol ('Standard' is rejected), and
// capacity is capped by the subscription quota (maxCapacity 3 per model on this account)
