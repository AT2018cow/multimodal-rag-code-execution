...
import os
import requests
from api_auth import session as api_auth_session
import time
...
class APIClient:
    ...
    def get_job_runners(self):
        try:
            response = api_auth_session.get(f"{self.base_url}/job_runners")
    ...
    def get_processing_plan(self):
        try:
            response = api_auth_session.get(f"{self.base_url}/processing_plan")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def get_models(self):
        try:
            response = api_auth_session.get(f"{self.base_url}/models")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def upload_files(self, index_name, files):
        try:
            response = api_auth_session.post(f"{self.base_url}/index/{index_name}/files", files=files)
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def get_existing_files(self, index_name):
        try:
            response = api_auth_session.get(f"{self.base_url}/index/{index_name}/files")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def get_index_documents(self, index_name):
        try:
            response = api_auth_session.get(f"{self.base_url}/index/{index_name}/documents")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def get_index_status(self, index_name):
        try:
            response = api_auth_session.get(f"{self.base_url}/index/{index_name}/status")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def update_index_status(self, index_name, status):
        try:
            response = api_auth_session.post(f"{self.base_url}/index/{index_name}/status", json={"status": status})
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def get_index_log(self, index_name):
        try:
            response = api_auth_session.get(f"{self.base_url}/index/{index_name}/log")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def copy_processing_plan_to_index(self, index_name):
        try:
            response = api_auth_session.post(f"{self.base_url}/index/{index_name}/plan")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def submit_ingestion_job(self, index_name, ingestion_params_dict):
        try:
            response = api_auth_session.post(f"{self.base_url}/index/{index_name}/aml_job", json=ingestion_params_dict)
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def submit_aca_ingestion_job(self, index_name, ingestion_params_dict):
        try:
            response = api_auth_session.post(f"{self.base_url}/index/{index_name}/container_apps_job", json=ingestion_params_dict)
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
            logging.error(f"Error submitting ingestion job: {e}")
    ...
    def submit_local_ingestion_job(self, index_name, ingestion_params_dict):
        try:
            response = api_auth_session.post(f"{self.base_url}/index/{index_name}/local_job", json=ingestion_params_dict)
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def get_job_status(self, job_id):
        try:
            response = api_auth_session.get(f"{self.base_url}/job/{job_id}")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
    ...
    def get_local_job_status(self, pid):
        try:
            response = api_auth_session.get(f"{self.base_url}/local_job/{pid}")
            response.raise_for_status()
            return response.json()
        except requests.exceptions.RequestException as e:
